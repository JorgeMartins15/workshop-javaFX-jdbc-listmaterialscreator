...
public class MachineListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Machine, Machine> tableColumnREMOVE;
	...
	private void initEditButtons() {
		...
		tableColumnEDIT.setCellFactory(param -> new TableCell<Machine, Machine>() {
			...
			protected void updateItem(Machine obj, boolean empty) {
				...
				setGraphic(button);
				button.setOnAction(event -> createDialogForm(obj, "/gui/MachineForm.fxml", Utils.currentStage(event)));
			}
		});
	}
	...
	private void initRemoveButtons() {
		...
		tableColumnREMOVE.setCellFactory(param -> new TableCell<Machine, Machine>() {
	...
	private void removeEntity(Machine obj) {
